...
const CommuteAnalysis = () => {
    ...
    const getSuggestions = (input) => {
        ...
        // Example LA locations
        const suggestions = [
        input + ", Los Angeles, CA 90001",
        input + " Street, Santa Monica, CA 90401",
        input + " Boulevard, Beverly Hills, CA 90210",
        input + " Avenue, Culver City, CA 90232",
        input + " Drive, Manhattan Beach, CA 90266"
        ];
    ...
    const handleAddressInput = (e) => {
        setCustomOfficeAddress(e.target.value);
